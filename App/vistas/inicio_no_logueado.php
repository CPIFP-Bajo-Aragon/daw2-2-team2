...
<main>
  ...
  <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="<?php echo RUTA_URL?>/images/index/rutas-moteras-bajo-aragon-21.jpg" class="col-sm-2 w-100 objetfit" alt="Bajo Aragon">
        <div class="container">
      ...
      <div class="carousel-item">
        ...
        <img src="<?php echo RUTA_URL?>/images/index/IMG_8958-2.jpg" class="col-sm-1 w-100 objetfit"  alt="Bajo Aragon">
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="<?php echo RUTA_URL?>/images/index/foto-bodega-san-pedro-igp-vino-bajo-aragon.jpg" class="col-sm-2 w-100 objetfit" alt="Bajo Aragon">
        <div class="container">
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        <img src="<?php echo RUTA_URL?>/images/index/contrato-de-alquiler-temporal.jpeg" class="bd-placeholder-img rounded-circle" width="140" height="140" alt="Alquiler Image">
      ...
      <div class="col-lg-4">
        <img src="<?php echo RUTA_URL?>/images/index/Traspaso.jpg" class="bd-placeholder-img rounded-circle" width="140" height="140" alt="Alquiler Image">
        <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-color)"/></svg> -->
      ...
      <div class="col-lg-4">
        <img src="<?php echo RUTA_URL?>/images/index/Biblioteca_Barzio.jpg" class="bd-placeholder-img rounded-circle" width="140" height="140" alt="Alquiler Image">
        <!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-color)"/></svg> -->
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Descubre tu nuevo hogar en alquiler. <span class="text-body-secondary">Encuentra el lugar perfecto para ti.</span></h2>
      ...
      <div class="col-md-5">
        <img src="<?php echo RUTA_URL?>/images/index/CASA-RURAL.jpg" alt="Imagen" class="img-fluid mx-auto" width="500" height="500">
      </div>      
    </div>
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading fw-normal lh-1">Oportunidades de traspasos. <span class="text-body-secondary">Haz crecer tu negocio.</span></h2>
      ...
      <div class="col-md-5">
        <img src="<?php echo RUTA_URL?>/images/index/panaderia.jpg" alt="Imagen" class="img-fluid mx-auto" width="500" height="500">
      </div> 
    </div>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Descubre servicios locales. <span class="text-body-secondary">Mejora tu experiencia de vida.</span></h2>
      ...
      <div class="col-md-5">
        <img src="<?php echo RUTA_URL?>/images/index/bar.jpg" alt="Imagen" class="img-fluid mx-auto" width="500" height="500">
      </div> 
    </div>
