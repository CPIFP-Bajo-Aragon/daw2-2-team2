  ...
  <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="<?php echo RUTA_URL_IMAGENES?>/index/car1.jpg" class="col-sm-2 w-100 objetfit" alt="Bajo Aragon">
        <div class="container">
      ...
      <div class="carousel-item">
        ...
        <img src="<?php echo RUTA_URL_IMAGENES?>/index/car2.jpg" class="col-sm-1 w-100 objetfit"  alt="Bajo Aragon">
        <div class="container">
      ...
      <div class="carousel-item">
        <img src="<?php echo RUTA_URL_IMAGENES?>/index/car3.jpg" class="col-sm-2 w-100 objetfit" alt="Bajo Aragon">
        <div class="container">
  ...
  <div class="container marketing mt-4">
    ...
    <div class="row">
      <div class="col-lg-4 justify-content-center align-items-center text-center">
        ...
        <p><a class="btn btn-secondary" href="<?php echo RUTA_URL?>/Alquiler">Ver alquileres &raquo;</a></p>
      </div>
      <div class="col-lg-4 justify-content-center align-items-center text-center">
        ...
        <p><a class="btn btn-secondary" href="<?php echo RUTA_URL?>/Traspaso">Ver traspasos  &raquo;</a></p>
      </div>
      <div class="col-lg-4 justify-content-center align-items-center text-center">
        ...
        <p><a class="btn btn-secondary" href="<?php echo RUTA_URL?>/Servicio">Ver servicios &raquo;</a></p>
      </div>
    </div>
